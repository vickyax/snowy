...
const WaveSection: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(-1.000000, -14.000000)" fillRule="nonzero">
            <g className="wave" fill="#34d399"> {/* Light green */}
      ...
      {/* Section Content */}
      <section className="mx-0 text-center w-full bg-green-400">
        <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-white pt-3">
        Support
        </h1>
        <div className="w-full mb-4">
          <div className="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t" />
        </div>
        <h3 className="my-4 text-3xl leading-tight mx-[50px]">

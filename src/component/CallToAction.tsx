...
const WaveSection: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Section Content */}
      <section className="mx-0 text-center w-full bg-[#00BFFF]/50">
        <h1 className="w-full my-2 text-4xl p-4 font-bold leading-tight text-center text-white pt-3">
        About Us
        </h1>

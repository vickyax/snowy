...
const ServiceSection= () => {
  ...
  return (
    <section className=" bg-gradient-to-r from-cyan-200/60   border-b transition-all duration-700 ease-in-out ">
      <div>
        {/* Flex row for heading and search */}
        <div className="w-full flex flex-col md:flex-row items-center justify-between mb-6 ">
          <h1 className="items-center flex flex-col md:flex-row ml-6 my-1 justify-between mt-6 text-4xl font-bold leading-tight text-gray-800 text-center md:text-left">
